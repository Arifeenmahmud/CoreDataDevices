...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CoreDataDevices",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15CoreDataDevices11AppDelegate")
...
SWIFT_CLASS("_TtC15CoreDataDevices6Person")
@interface Person : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface Person (SWIFT_EXTENSION(CoreDataDevices))
...
SWIFT_CLASS("_TtC15CoreDataDevices13SceneDelegate")
...
SWIFT_CLASS("_TtC15CoreDataDevices14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
- (void)viewDidLoad;
- (IBAction)onPlusTapped;
...
@interface ViewController (SWIFT_EXTENSION(CoreDataDevices)) <UITableViewDataSource>
